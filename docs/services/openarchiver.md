...
For details about configuring the [Ansible role for Open Archiver](https://radicle.network/nodes/iris.radicle.network/rad%3Az2Q7Pka6bCT5D6Ng54kT8UcYAcVTC), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az2Q7Pka6bCT5D6Ng54kT8UcYAcVTC/tree/docs/configuring-openarchiver.md) online

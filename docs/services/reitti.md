...
For details about configuring the [Ansible role for Reitti](https://radicle.network/nodes/iris.radicle.network/rad%3Az3rhdtDR5EHHGk1SNBHwYtofxNyAf), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3rhdtDR5EHHGk1SNBHwYtofxNyAf/tree/docs/configuring-reitti.md) online
...
If you configured the dedicated Valkey instance above, run the installation for its supplementary inventory host before running it for the main inventory host:

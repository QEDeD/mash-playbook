...
For details about configuring the [Ansible role for Bar Assistant](https://radicle.network/nodes/iris.radicle.network/rad%3Az3JDUHjeHMqbZ3YLxquSUbCmAJLi), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3JDUHjeHMqbZ3YLxquSUbCmAJLi/tree/docs/configuring-barassistant.md) online

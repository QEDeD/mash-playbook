...
After running the command for installation, the Notfellchen instance becomes available at the URL specified with `notfellchen_hostname`. With the configuration above, the service is hosted at `https://notfellchen.example.com`.

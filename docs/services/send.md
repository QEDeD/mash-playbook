...
If you are unsure whether you will install other services along with Send or you have already set up services which need Valkey (such as [Nextcloud](nextcloud.md), [PeerTube](peertube.md), and [Docmost](docmost.md)), it is recommended to install a Valkey instance dedicated to Send.
